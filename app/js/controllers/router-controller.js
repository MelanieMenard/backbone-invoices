...
InvoiceApp.RouterController = Backbone.Marionette.Object.extend({
...
/* --- Initialisation code: init modules and pass them the data they need  --- */
  ...
  initialize: function(config) {
    ...
    this.appLayout = new InvoiceApp.AppLayout({
...
/* --- the router tells the app layout to show a specific child view in the 'main' region, depending of which route is requested --- */
  ...
  showInvoicesScreen: function() {
    this.appLayout.showInvoicesScreen();
  },

  showInvoiceAddScreen: function() {
    this.appLayout.showInvoiceAddScreen();
  },

  showInvoiceEditScreen: function(invoiceId) {
    this.appLayout.showInvoiceEditScreen(invoiceId);
  }
