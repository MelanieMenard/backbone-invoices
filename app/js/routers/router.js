...
InvoiceApp.Router = Backbone.Marionette.AppRouter.extend({
  ...
  appRoutes: {
    ...
    'invoices(/)': 'showInvoicesScreen',
    'add-invoice(/)': 'showInvoiceAddScreen',
    'edit-invoice/:invoiceId': 'showInvoiceEditScreen',
